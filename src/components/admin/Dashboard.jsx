...
const Dashboard = () => {
  ...
  const fetchSubjects = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://sinfbackend1.onrender.com/api/subjects`,
        { fanId },
        {
          headers: {
  ...
  const handleDeleteUsers = async (id) => {
    ...
    try {
      ...
      await axios.delete(`https://sinfbackend1.onrender.com/admin/users/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
...
const handleDelete = async (id) => {
  ...
  try {
    ...
    await axios.delete(`https://sinfbackend1.onrender.com/admin/subjects/${id}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  const handleSubjectClick = async (subject) => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://sinfbackend1.onrender.com/admin/subjects/${subject._id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
