...
const AdminCrud = () => {
  ...
  const fetchAdmins = async () => {
    const token  = localStorage.getItem('token') 
    try {
      const response = await axios.get('https://sinfbackend1.onrender.com/api/admins',
        {
          headers: {
  ...
  const createAdmin = async () => {
    const token = localStorage.getItem('token'); 
    try {
        const response = await axios.post('https://sinfbackend1.onrender.com/api/admin',
  ...
  const updateAdmin = async (id) => {
    const token  = localStorage.getItem('token') 
    try {
      const response = await axios.put(`https://sinfbackend1.onrender.com/api/admin/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const deleteAdmin = async (id) => {
    const token  = localStorage.getItem('token') 
    try {
      await axios.delete(`https://sinfbackend1.onrender.com/api/admin/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
